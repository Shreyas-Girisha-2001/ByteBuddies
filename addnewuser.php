...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$result=adduser($firstname,$middlename,$lastname,$username,$email,$passwordHash,$registeredAt,$bio,$restricted,$superuser,$securityQuestion1,$securityAnswer1,$securityQuestion2,$securityAnswer2);
